  ...
  if (!user) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-brand-dark px-4">
        <form
          onSubmit={handleAuth}
          className="w-full max-w-md space-y-4 rounded-2xl bg-brand-panel p-8 shadow-xl border border-slate-700/50"
        >
          ...
          <p
            className="text-center text-xs text-slate-400 cursor-pointer"
